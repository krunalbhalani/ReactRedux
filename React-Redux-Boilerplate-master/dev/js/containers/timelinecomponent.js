...
class TimelineComponent extends Component
{
    constructor(props){
        super(props);
        this.state = { mySchedule: [{name:"Wake up", date: "2012-09-28T06:00:00"},
    ...
    componentDidMount()
    {
      this.TimeKnotsdraw(this.refs.timeline2, this.state.mySchedule, {horizontalLayout: true, color: "#669", height: 100, width:500, showLabels: true, labelFormat:"%H:%M"});
    }

    TimeKnotsdraw (id, events, options) {
          var cfg = {
            width: 600,
            height: 200,
            radius: 10,
